  ...
  return (
    <AlurakutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        <AlurakutMenu.Logo src={`https://dddconstrucao.com.br/wp-content/uploads/2021/05/Group-5.png`} style = {{ backgroundColor:'#F2B90F' }} />
        ...
        <nav>
          ...
          <div>
            <input placeholder="Pesquisar Região" />
          </div>
        </nav>
